...
<section class="vh-200 bg-image"
	style="color: black;  background-image: url('https://mdbcdn.b-cdn.net/img/Photos/new-templates/search-box/img4.webp');">
				...
				<div class="col-12 col-md-9 col-lg-7 col-xl-6">
					<div class="card" style="border-radius: 15px;">
						<div class="card-body p-5">
							...
							<form:form method="POST" action="qwantri/addNV.htm"
								...
								<p class="text-center text-muted mt-5 mb-0">
									Have already an account? <a href="/BanDongHo/index/sign-in.htm"
